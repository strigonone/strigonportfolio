    ...
    <div>
      ...
      <Container maxWidth="lg">
        <Paper className={classes.paper}>
          <h1>LevelUp Works / Mission Ready HQ – Level 4 Project</h1>
          ...
          <li>
            Recreated a website based on provided UI/UX PDF mockups using React
            (CRA)t
          </li>
          <li>
            Built a simple full-stack platform focused on educational content
            for children
          </li>
          <li>
            Applied raw CSS for styling to match original design specifications
          </li>
          <li>
            Developed a MySQL database for student login, profiles, and data
            handling
          </li>
          <li>Database hosted on ScaleGrid (account since expired)</li>
          <li>
            Collaborated in a two-person team, contributing code and helping
            peers
          </li>
          <li>
            Final product demonstrated functionality in a recorded video
            presentation (now unavailable)
          </li>
