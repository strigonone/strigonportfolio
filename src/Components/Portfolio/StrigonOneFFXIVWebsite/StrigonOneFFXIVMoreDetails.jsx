    ...
    <div>
      ...
      <Container maxWidth="lg">
        <Paper className={classes.paper}>
          ...
          >
            Date: 2021 - 2022 (Decommissioned)
          </Typography>
          <h4>
            A simple website that hosted and showcased my work, and also where I
            first adopted the name “Strigon One.”
          </h4>
          <li>
            Created a dedicated platform for mod users to browse over 200 custom
            mods and contact me directly
          </li>
          <li>
            Currently planning a complete rebuild using
            <strong>Typescript</strong> and <strong>React</strong> to modernize
            the project.
          </li>
          <li>
            Self-taught in using WordPress for site creation, customization
            (Elementor), and analytics tracking
          </li>
          <li>Managed all content, hosting, and user engagement myself</li>
